package com.base.common.app.widget.pop;
 ...
 * 内部类不能有内部类
 *
 * Adapter 中的 ViewHolder ，如果 Adapter 为内部类，viewholder 会报问题
 */
...
//        int screenHeight = dm.heightPixels;
    ...
    public  class SimpleAdapter<T> extends RecyclerView.Adapter<MyViewHolder> {
        private List<T> list;
