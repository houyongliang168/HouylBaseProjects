...
public class BasePickerView {
    ...
    protected void initViews(int backgroudId) {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.basemodule_layout_basepickerview, null, false);
            //设置界面的背景为透明
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.basemodule_layout_basepickerview, decorView, false);
