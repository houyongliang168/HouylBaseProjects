package com.base.widget.time_picker;
...
import com.base.basemodule.app.widget.time_picker.listener.OnDateSelectedListener;
import com.base.basemodule.app.widget.time_picker.view.WheelTime;
 ...
 */
public class TimePickerView extends BasePickerView implements View.OnClickListener ,OnDateSelectedListener {
    ...
    public static class Builder {
        private int layoutRes = R.layout.basemodule_pickerview_time;
        private CustomListener customListener;
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.basemodule_pickerview_time, contentContainer);
