package com.base.widget.time_picker.lib;
...
import com.base.widget.time_picker.adapter.WheelAdapter;
import com.base.widget.time_picker.listener.OnItemSelectedListener;
import com.base.widget.time_picker.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
       ...
       /* textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.text20);//默认大小
