package com.base.widget.time_picker.view;

import android.view.View;


import com.base.hyl.houbasemodule.R;
import com.base.widget.time_picker.adapter.NumericWheelAdapter;
...
public class WheelTime {
    ...
    public WheelTime(View view, boolean[] type, int gravity, int textSize, OnDateSelectedListener dateSelectedListener) {
        super();
        this.view = view;
        this.type = type;
        this.gravity = gravity;
