...
import com.base.common.image.GlideCircleTransform;
...
public class ImageManager {
    ...
    public void downloadImage(Context context, String imgUrl, String path, String fileName, boolean isOverride) {
        try {
            File file = null;
            if (com.base.common.file.FileUtil.isFileExists(path + fileName)) {
                if (!isOverride) {
                    return;
                }
                ...
                if (!com.base.common.file.FileUtil.isFileExists(path)) {
     ...
     * @param imgUrl
     */
    public void loadOwnerCircleImage(Context context, ImageView imageView, int imgUrl,int error ,int placeholder) {
        if (flag_loadImage) {
            Glide.with(context)
                    .load(imgUrl)
                    .placeholder(placeholder) // can also be a drawable
                    .error(error) // will be displayed if the image cannot be loade
