...
public class DefaultDownloadHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_DOWNLOAD_TABLE = String.format(
            "CREATE TABLE %s (_id varchar(255) PRIMARY KEY NOT NULL,supportRanges integer NOT NULL,createAt long NOT NULL,uri varchar(255) NOT NULL,path varchar(255) NOT NULL,size long NOT NULL, progress long NOT NULL,status integer NOT NULL,imgUrl varchar(255) NOT NULL,title varchar(255) NOT NULL,description varchar(255) ,isSelected integer NOT NULL,isBanner integer NOT NULL);",
